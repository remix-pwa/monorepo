...
// ../packages/dev/worker-build.ts
throw new Error(
  "@remix-pwa/dev/worker-build is not meant to be used directly from node_modules. It exists to provide type definitions for a virtual module provided by the Remix compiler at build time."
);
var entry = void 0;
var routes = void 0;
